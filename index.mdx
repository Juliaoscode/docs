...
<div className="video-background-container">
  ...
  <div className="hero-section">
    <div className="hero-content">
      <h1 style={{fontSize: '3rem', marginBottom: '1rem'}}>Welcome to Your Documentation</h1>
      <p style={{fontSize: '1.5rem', marginBottom: '2rem'}}>Build beautiful documentation in minutes</p>
    </div>
  </div>
</div>
